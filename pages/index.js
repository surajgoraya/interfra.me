            ...
            <div className="app__content_container">
              ...
              <div className="app__body" style={{ opacity: onBodyComplete ? 1 : 0, animationDelay: 500 + 'ms' }} onAnimationEnd={() => setOnBodyComplete(true)}>
                ...
                <div className="app__letter">
                  <p>Helloooo!</p>
                  <p>{"First and for most, I want to thank each and everyone of you for all the support "}<i><a href='https://fanlink.to/ewbok'>Everything Will Be Ok</a></i>
                    {" has received this year! This was my first major/\"real\" release I've ever done, and it has exceeded all my expectations!"}</p>
                  ...
                  <p>{"I want to give a special shout out to "}<a href="https://twitter.com/Jpreet_">Jpreet</a>{", for all his amazing design work, the "}
                    <a href="https://beardgel.ca">Beardgel Crew</a>{" for hyping up and supporting this release, and of course all of my amazing friends, family, and most of all, listeners."}</p>
                  <br />
